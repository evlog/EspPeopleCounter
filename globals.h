...
String UPDATE_BINARY_FILE_PATH = "http://update.switchfi.co.za/firmware/counteresp32.bin";

// Array to hold measurements for the standard deviation calculation
//const int measArrSize = 5;
...
//const char* MQTT_PASSWORD = "rjastarmas1"; 
...
uint32_t INTER_MEASUREMENT_PERIOD_MS = 50;

const uint32_t DISTANCES_ARRAY_SIZE = 10;

uint32_t MAX_DISTANCE = 800;
...
uint32_t DIST_THRESHOLD_MAX[] = {750, 750};   // treshold of the two zones
